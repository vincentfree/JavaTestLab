...
public class BrugApplet extends java.applet.Applet implements Runnable {
    ...
    public void init() {
        ...
        brug = new Brug(150, 80, lock,condition);
        auto1 = new Auto(363, 79, 12,lock,condition);        //initialiseren van auto1.
        auto1.setPlaatje(getImage(getDocumentBase(), "autobw.gif"));  //plaatje aan auto koppelen.
        auto1.setBrug(brug);
        auto1.start();
        auto2 = new Auto(363, 79, 7,lock,condition);        //initialiseren van auto2.
